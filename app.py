...
if not st.session_state.connecte:
    ...
    st.sidebar.caption("Plateforme éducative intelligente")
    st.sidebar.markdown("---")
    ...
    if st.sidebar.button(
        ...
        st.session_state.connecte = False
        st.session_state.pop("nom_utilisateur", None)
